...
#######################################################################################################################
input_file = f"{iGCS_BaseDir}/DnB_Full_May2025.csv"
...
output_table = f"{PROJECT_ID}.{oBQ_DatasetID}.DnB_Full_May2025_full_Dataset"
df.write.mode("overwrite").format("bigquery").save(output_table)
